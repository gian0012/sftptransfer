        ...
        <div>
            <div className="w-full  content-center flex flex-col justify-center items-center">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="bg-[#111827] rounded-md p-4 mt-3">
                        ...
                        <div className="grid md:grid-cols-2 md:gap-6">
                            <div className="mb-6">
                                ...
                                <input type="text" id="address"
                                       ...
                                       placeholder="192.123.1.123" required/>
                            </div>
                            <div className="mb-6">
                        ...
                        <div className="grid md:grid-cols-3 md:gap-6">
                            <div className="mb-6">
                                <label htmlFor="username"
                                       className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">SSH Username</label>
                            ...
                            <div className="mb-6">
                                <label htmlFor="port"
                                       className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">SSH Port
                                    </label>
                            ...
                            <div className="mb-6">
                                <label htmlFor="folder"
                                       className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Destination folder
                                    </label>
                            ...
                            <div className="mb-6">
                                <div className="flex items-center justify-center w-full">
                                    <label htmlFor="dropzone-file"
                                        ...
                                        <input id="dropzone-file" type="file" className="hidden" on/>
                                    </label>
                                </div>
                            </div>
                        </div>
